    ...
    <el-collapse v-model="active" accordion>
      ...
      <el-collapse-item title="开发注意事项" name="develop">
        <div style="
            ...
            ">
          配置文件读取的总是与
          <tt>index.html</tt> 同级的 <tt>./static/configuration.json</tt> ,
          而修改配置的时候是通过 <tt>github-api</tt> 修改
          <tt>你的用户名.github.io</tt> 下的
          <tt>/static/configuration.json</tt>, 所以本地
          <tt>npm run dev</tt> 的时候会出现修改配置无效的情况,
          如果需要修改的话修改本地的配置文件就行, 发布到
          <tt>github</tt> 之后不影响
        </div>
      </el-collapse-item>
    </el-collapse>
...
export default {
  data() {
    return {
      ...
      deploy: {
        images: [
          require("../../../static/deploy0.png"),
          require("../../../static/deploy1.png"),
          require("../../../static/deploy2.png"),
        ],
        status: "process",
        active: 0,
      },
      use: {
        images: [
          require("../../../static/use0.png"),
          require("../../../static/use1.png"),
          require("../../../static/use2.png"),
        ],
        status: "process",
        active: 0,
      },
